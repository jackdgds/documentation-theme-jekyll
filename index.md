...
summary: These brief instructions will help you get started quickly with the theme. The other topics in this help provide additional information and detail about working with other aspects of this theme and Jekyll, plus several other features.
---
...
Follow these instructions to build the theme. Follow these instructions to build the theme
